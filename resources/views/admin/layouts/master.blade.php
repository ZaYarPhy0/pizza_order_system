                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__body ">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('account#acountProfile') }}" class="text-decoration-none">
                                                        <i class="zmdi zmdi-account"></i>Account</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body ">
                                                <div class="account-dropdown__item">
                                                    <a href="{{ route('account#adminList') }}" class="text-decoration-none">
                                                        <i class="fa-solid fa-users"></i>Admin Lists</a>
                                                </div>
                                            </div>
                                            <div class="account-dropdown__body text-decoration-none">
                                                <div class="account-dropdown__item">
                                            ...
                                            <div class="account-dropdown__footer">
                                                ...
                                                @csrf
                                                <button type="submit" class="btn btn-primary my-3 px-5"><i class="zmdi zmdi-power me-2"></i>logout</button>
                                            </form>
                                            </div>
                                        </div>
                                    </div>
